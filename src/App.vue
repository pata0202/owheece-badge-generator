  ...
  <div class="md:px-12 px-5 py-10 bg-gray-100 min-h-screen" id="app">
    ...
    <footer class="mt-16 pb-8 text-center">
      <div class="flex items-center justify-center gap-2 text-gray-600">
        ...
        <a href="https://github.com/pata0202/owheece-badge-generator" target="_blank" rel="noopener noreferrer" class="hover:text-violet-600 transition-colors font-medium">
          檢視專案原始碼
        </a>
      </div>
      <p class="text-sm text-gray-500 mt-2">
        本專案採開源授權，程式碼全數公開於 GitHub 上
      </p>
    </footer>
  </div>
</template>
